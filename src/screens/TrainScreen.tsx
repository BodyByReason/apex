...
const EXERCISE_LIBRARY = [
  ...
  { icon: '🔼', name: 'Pull-Up', muscles: 'Back · Biceps', cat: 'Back', defaultSets: '4 x max', youtubeId: 'eGo4IYlbE5g' },
  { icon: '🔼', name: 'Barbell Row', muscles: 'Mid Back · Lats', cat: 'Back', defaultSets: '4 x 6', youtubeId: 'kBWAon7ItDw' },
  { icon: '🔼', name: 'Lat Pulldown', muscles: 'Lats · Biceps', cat: 'Back', defaultSets: '3 x 10', youtubeId: '' },
  { icon: '🔼', name: 'Seated Cable Row', muscles: 'Mid Back · Lats', cat: 'Back', defaultSets: '3 x 10', youtubeId: 'GZbfZ033f74' },
  { icon: '🔼', name: 'Face Pulls', muscles: 'Rear Delt · Rotator Cuff', cat: 'Back', defaultSets: '4 x 15', youtubeId: 'HSoHeSjfOpk' },
  { icon: '🔼', name: 'Single Arm DB Row', muscles: 'Lats · Rhomboids', cat: 'Back', defaultSets: '3 x 10 each', youtubeId: '' },
  { icon: '🏋️', name: 'Overhead Press', muscles: 'Shoulders · Triceps', cat: 'Shoulders', defaultSets: '4 x 8', youtubeId: 'QAQ64hK4d00' },
  { icon: '🏋️', name: 'Lateral Raises', muscles: 'Side Delts', cat: 'Shoulders', defaultSets: '4 x 15', youtubeId: 'kDqklk1ZESo' },
  ...
  { icon: '🦾', name: 'Hammer Curls', muscles: 'Biceps · Brachialis', cat: 'Arms', defaultSets: '3 x 10 each', youtubeId: 'zC3nLlEvin4' },
  { icon: '🦾', name: 'Tricep Pushdowns', muscles: 'Triceps', cat: 'Arms', defaultSets: '3 x 12', youtubeId: '2-LAMcpzODU' },
  { icon: '🏋️', name: 'Back Squat', muscles: 'Quads · Glutes', cat: 'Legs', defaultSets: '4 x 6', youtubeId: 'ultWZbUMPL8' },
  { icon: '🏋️', name: 'Romanian Deadlift', muscles: 'Hamstrings · Glutes', cat: 'Legs', defaultSets: '3 x 8', youtubeId: 'JCXUYuzwNrM' },
          ...
          <>
            ...
            {(() => {
              ...
              const allEx = [
                ...
                // Arms
                { icon: '🦾', name: 'Barbell Curl', muscles: 'Biceps', cat: 'Arms', defaultSets: '3 x 10', youtubeId: '' },
                { icon: '🦾', name: 'DB Curls', muscles: 'Biceps', cat: 'Arms', defaultSets: '3 x 12 each', youtubeId: 'ykJmrZ5v0Oo' },
                { icon: '🦾', name: 'Hammer Curls', muscles: 'Biceps · Brachialis', cat: 'Arms', defaultSets: '3 x 10 each', youtubeId: 'zC3nLlEvin4' },
                { icon: '🦾', name: 'Tricep Pushdowns', muscles: 'Triceps', cat: 'Arms', defaultSets: '3 x 12', youtubeId: '2-LAMcpzODU' },
